...
运行命令:
  完整动画: manim -pql data_wall_projection.py DataWallProjection
  高质量渲染: manim -pqh data_wall_projection.py DataWallProjection
  4K渲染: manim -pqk data_wall_projection.py DataWallProjection
"""
